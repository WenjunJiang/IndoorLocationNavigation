...
if __name__ == "__main__":
    ...
    html_filename = str(Path(html_filename).resolve())
    save_figure_to_html(fig, html_filename)
    calibrate_magnetic_wifi_ibeacon_to_position(["/Users/anooshhari/Documents/Anoosh/Masters/Spring 21/Classes/6100 - BigData Analytics for C/Project/indoor-location-navigation/train/5a0546857ecc773753327266/B1/5e1581d4f4c3420006d52109.txt"])
